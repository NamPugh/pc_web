    ...
    <section className="space-y-6">
      <div className="overflow-hidden rounded-lg border border-[#ededed] bg-white shadow-sm">
        <div className="grid gap-0 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="p-6 sm:p-8">
            <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-[#D91605]">Hỗ trợ khách hàng</p>
            <h1 className="mt-2 max-w-2xl text-4xl font-bold tracking-tight text-[#29324e] sm:text-5xl">Cần tư vấn cấu hình, đơn hàng hoặc bảo hành?</h1>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-[#444]">
          ...
          <div className="bg-[#1e1e1e] p-6 text-white sm:p-8">
            <Headphones className="size-9 text-white/80" />
            ...
            <div className="mt-5 grid gap-3 text-sm">
              <p className="inline-flex items-center gap-3 rounded-md border border-white/15 bg-white/10 p-4 text-white/82">
                <PhoneCall className="size-5 text-white/80" />
                0911111111
              </p>
              <p className="inline-flex items-center gap-3 rounded-md border border-white/15 bg-white/10 p-4 text-white/82">
              ...
              <p className="inline-flex items-center gap-3 rounded-md border border-white/15 bg-white/10 p-4 text-white/82">
                <MapPin className="size-5 text-white/80" />
                114 Chiến Thắng, Hà Nội
              </p>
              <p className="inline-flex items-center gap-3 rounded-md border border-white/15 bg-white/10 p-4 text-white/82">
                <Clock3 className="size-5 text-white/80" />
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {supportCards.map((item) => {
          ...
          return (
            <Link key={item.title} to={item.href} className="group rounded-lg border border-[#ededed] bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-[#fb4e4e] hover:shadow-sm">
              ...
              <h2 className="mt-4 text-xl font-bold tracking-tight text-[#29324e]">{item.title}</h2>
      ...
      <section className="rounded-lg border border-[#ededed] bg-white p-5 shadow-sm">
        <h2 className="text-2xl font-bold tracking-tight text-[#29324e]">Câu hỏi thường gặp</h2>
        <div className="mt-4 grid gap-3 md:grid-cols-2">
          {faqs.map((faq) => (
            <div key={faq} className="rounded-md bg-[#f5f5f5] p-4 text-sm leading-6 text-[#444]">
              {faq}
            </div>
          ))}
        </div>
